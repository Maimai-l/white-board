...
- **橡皮是对象橡皮擦**：碰到哪一笔就整笔删掉，作用点在笔尖，默认就是最细那一档
  （直径 6），大小不随笔身角度或者快慢变。普通工具栏里可以调粗，五档到 50 为止，
  再粗就不是「碰到哪一笔删哪一笔」而是在扫了。
  会跟着倾斜变粗的是**像素橡皮擦**，按笔迹的像素擦——白板的笔迹是矢量的，
  没有这回事，所以笔具盘里那个「像素 / 对象」二选一也去掉了。
