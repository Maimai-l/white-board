 ...
 *
 * 37° 和 35° 之间这个台阶很陡（16.5 跳到 35）。两侧是两种量法：35° 及以下来自孤立
 * 点的洞面积换算的等效直径，37° 及以上来自沿拖动路径量的垂直宽度。如果低倾角的
 * 落笔形状不是圆而是沿笔身拉长的椭圆，等效直径会比垂直宽度大，台阶就是量法差异而
 * 不是真的跳变。37°～25° 之间没有拖动样本，这一段是曲线里最没把握的部分。
 */
const ERASER_CURVE = [
  [90, 6],
  [80, 7.5],
